...
type BalancedSolver struct {
	Instructions []Instruction
}

func NewBalancedSolver() *BalancedSolver {
	return &BalancedSolver{}
}

func (s *BalancedSolver) ProcessInput(input string) error {
...
func (s *BalancedSolver) Name() string {
	return "Balanced Solver"
}

func (s *BalancedSolver) Part1() (string, error) {
	const DIALS = 100
	pos := 50
	counter := 0
...
func (s *BalancedSolver) Part2() (string, error) {
	const DIALS = 100
	pos := 50
	counter := 0
